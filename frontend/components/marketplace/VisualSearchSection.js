...
export default function VisualSearchSection({ viewerRole }) {
  ...
  return (
    <section id="visual-search" className="scroll-mt-32 bg-[#050505] py-12 sm:py-16">
      <div className="marketplace-container">
        <div className="relative overflow-hidden rounded-[2rem] border border-red-500/20 bg-[radial-gradient(circle_at_80%_50%,rgba(255,47,54,.18),transparent_32%),#0d0d0f] px-6 py-10 text-white shadow-2xl shadow-red-950/20 sm:px-10 sm:py-14 lg:px-16">
          ...
          <div className="absolute -right-16 -top-20 h-72 w-72 rounded-full border-[42px] border-red-500/20" />
          <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_0.7fr]">
            ...
            <div aria-hidden="true" className="mx-auto w-full max-w-sm rounded-3xl border border-white/15 bg-white/[0.07] p-5 backdrop-blur">
              <div className="flex aspect-[4/3] items-center justify-center rounded-2xl border border-dashed border-red-400/30 bg-black/60">
